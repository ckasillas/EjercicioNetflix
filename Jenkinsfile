            ...
            steps {
                dir("ZuulBase/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        ...
                        sh "docker build -t ckasillas/zuul:latest ."
                        ...
                        sh 'docker push ckasillas/zuul:latest'
                    }
                }
            }
        }
        ...
        stage('Eureka') {
            ...
            steps {
                dir("EurekaBase/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ckasillas/eureka:latest ."
                        ...
                        sh 'docker push ckasillas/eureka:latest'
                    }
                }
            }
        }
        ...
        stage('Ordenes') {
            ...
            steps {
                dir("ordenes-service/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ckasillas/ordenes-service:latest ."
                        ...
                        sh 'docker push ckasillas/ordenes-service:latest'
                    }
                }
            }
        }
        ...
        stage('Productos') {
            ...
            steps {
                dir("productos-service/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ckasillas/productos-service:latest ."
                        ...
                        sh 'docker push ckasillas/productos-service:latest'
                    }
                }
            }
        }
        ...
        stage('Usuarios') {
            ...
            steps {
                dir("usuarios-service/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ckasillas/usuarios-service:latest ."
                        ...
                        sh 'docker push ckasillas/usuarios-service:latest'
                    }
                }
            }
        }
